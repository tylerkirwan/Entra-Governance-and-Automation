...
**Why expire the package?** <br> :question:
...
**Why does this flow insist on using Microsoft Authenticator passkeys (within the app) over other phish resistant methods?** <br> :question:
